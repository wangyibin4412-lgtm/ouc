 ...
 * @date: Oct.20,2023
 * @version: 1.0
 * @brief: This header file contains the definition of CmdLine.
 * @copyright (c) 2023 by Algo1010 Technologny Co.,Ltd.
 * All rights reserved.
 */

#ifndef _ALGO_CMDLINE_H
#define _ALGO_CMDLINE_H
...
namespace Algo1010
{
    ...
    public:
        ...
        template <class T>
        static OptionField<T> make_option(char c, T &field, std::string name = "")
        {
